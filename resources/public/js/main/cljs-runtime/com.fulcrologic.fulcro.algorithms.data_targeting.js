...
/** @this {Function} */
com.fulcrologic.fulcro.algorithms.data_targeting.multiple_targets.cljs$lang$applyTo = (function (seq61834){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq61834));
});
...
var args__4736__auto__ = [];
var len__4730__auto___61859 = arguments.length;
var i__4731__auto___61860 = (0);
while(true){
if((i__4731__auto___61860 < len__4730__auto___61859)){
args__4736__auto__.push((arguments[i__4731__auto___61860]));

var G__61861 = (i__4731__auto___61860 + (1));
i__4731__auto___61860 = G__61861;
continue;
} else {
}
break;
...
return (function (state__$1,p__61845){
var vec__61846 = p__61845;
var command = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61846,(0),null);
var data_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61846,(1),null);
var already_has_ident_at_path_QMARK_ = ((function (vec__61846,command,data_path,actions){
return (function (data_path__$1){
return cljs.core.some(((function (vec__61846,command,data_path,actions){
return (function (p1__61840_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__61840_SHARP_,ident);
});})(vec__61846,command,data_path,actions))
,cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(state__$1,data_path__$1));
});})(vec__61846,command,data_path,actions))
;
var G__61849 = command;
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(state__$1,data_path,((function (G__61849,G__61849__$1,already_has_ident_at_path_QMARK_,vec__61846,command,data_path,actions){
return (function (p1__61841_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [ident], null),p1__61841_SHARP_);
});})(G__61849,G__61849__$1,already_has_ident_at_path_QMARK_,vec__61846,command,data_path,actions))
);
}
...
taoensso.timbre._log_BANG_.cljs$core$IFn$_invoke$arity$10(taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"error","error",-978969032),"com.fulcrologic.fulcro.algorithms.data-targeting",null,93,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay(((function (path_to_vector,to_many_QMARK_,index,vector,G__61849,G__61849__$1,already_has_ident_at_path_QMARK_,vec__61846,command,data_path,actions){
return (function (){
...
});})(path_to_vector,to_many_QMARK_,index,vector,G__61849,G__61849__$1,already_has_ident_at_path_QMARK_,vec__61846,command,data_path,actions))
,null)),null,-2120626967);
}

if(to_many_QMARK_){
if((!(cljs.core.vector_QMARK_(vector)))){
taoensso.timbre._log_BANG_.cljs$core$IFn$_invoke$arity$10(taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"error","error",-978969032),"com.fulcrologic.fulcro.algorithms.data-targeting",null,96,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay(((function (path_to_vector,to_many_QMARK_,index,vector,G__61849,G__61849__$1,already_has_ident_at_path_QMARK_,vec__61846,command,data_path,actions){
return (function (){
...
,null)),null,1798261632);
} else {
if((!(typeof index === 'number'))){
taoensso.timbre._log_BANG_.cljs$core$IFn$_invoke$arity$10(taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"error","error",-978969032),"com.fulcrologic.fulcro.algorithms.data-targeting",null,97,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay(((function (path_to_vector,to_many_QMARK_,index,vector,G__61849,G__61849__$1,already_has_ident_at_path_QMARK_,vec__61846,command,data_path,actions){
return (function (){
...
,null)),null,1236794380);
} else {
if((!(cljs.core.contains_QMARK_(vector,index)))){
taoensso.timbre._log_BANG_.cljs$core$IFn$_invoke$arity$10(taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"error","error",-978969032),"com.fulcrologic.fulcro.algorithms.data-targeting",null,98,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay(((function (path_to_vector,to_many_QMARK_,index,vector,G__61849,G__61849__$1,already_has_ident_at_path_QMARK_,vec__61846,command,data_path,actions){
return (function (){
...
/** @this {Function} */
com.fulcrologic.fulcro.algorithms.data_targeting.integrate_ident_STAR_.cljs$lang$applyTo = (function (seq61842){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__61843,G__61844,seq61842__$2);
});
...
var G__61853 = cljs.core.assoc_in(state_map,target,item_to_place);
if(cljs.core.truth_(remove_source_QMARK_)){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__61853,source_path);
} else {
return G__61853;
}
} else {
if(com.fulcrologic.fulcro.algorithms.data_targeting.multiple_targets_QMARK_(target)){
var G__61854 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (item_to_place,many_idents_QMARK_){
return (function (s,t){
...
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__61854,source_path);
} else {
return G__61854;
}
} else {
...
if(com.fulcrologic.fulcro.algorithms.data_targeting.special_target_QMARK_(target)){
var G__61855 = state_map;
var G__61855__$1 = (cljs.core.truth_(remove_source_QMARK_)?cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__61855,source_path):G__61855);
var G__61855__$2 = ((com.fulcrologic.fulcro.algorithms.data_targeting.prepend_target_QMARK_(target))?com.fulcrologic.fulcro.algorithms.data_targeting.integrate_ident_STAR_.cljs$core$IFn$_invoke$arity$variadic(G__61855__$1,item_to_place,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prepend","prepend",342616040),target], 0)):G__61855__$1);
var G__61855__$3 = ((com.fulcrologic.fulcro.algorithms.data_targeting.append_target_QMARK_(target))?com.fulcrologic.fulcro.algorithms.data_targeting.integrate_ident_STAR_.cljs$core$IFn$_invoke$arity$variadic(G__61855__$2,item_to_place,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"append","append",-291298229),target], 0)):G__61855__$2);
if(com.fulcrologic.fulcro.algorithms.data_targeting.replacement_target_QMARK_(target)){
return com.fulcrologic.fulcro.algorithms.data_targeting.integrate_ident_STAR_.cljs$core$IFn$_invoke$arity$variadic(G__61855__$3,item_to_place,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"replace","replace",-786587770),target], 0));
} else {
return G__61855__$3;
}
} else {
