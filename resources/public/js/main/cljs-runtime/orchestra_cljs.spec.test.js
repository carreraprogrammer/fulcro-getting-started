...
var fexpr__57016 = (function (p__57017,seen__$1){
while(true){
var vec__57018 = p__57017;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57018,(0),null);
var xs__$1 = vec__57018;
var temp__5804__auto__ = cljs.core.seq(xs__$1);
if(temp__5804__auto__){
var s = temp__5804__auto__;
var v = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(x) : f.call(null,x));
if(cljs.core.contains_QMARK_(seen__$1,v)){
var G__57278 = cljs.core.rest(s);
var G__57279 = seen__$1;
p__57017 = G__57278;
seen__$1 = G__57279;
continue;
} else {
...
var caller = orchestra_cljs.spec.test.find_caller((function (){var G__57027 = orchestra_cljs.spec.test.get_host_port();
var G__57028 = (new Error()).stack;
var G__57029 = orchestra_cljs.spec.test.get_env();
var G__57030 = null;
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__57027,G__57028,G__57029,G__57030) : cljs.stacktrace.parse_stacktrace.call(null,G__57027,G__57028,G__57029,G__57030));
})());
var via = (function (){var temp__5806__auto__ = (function (){var fexpr__57033 = new cljs.core.Var(function(){return cljs.spec.alpha.spec_name;},new cljs.core.Symbol("cljs.spec.alpha","spec-name","cljs.spec.alpha/spec-name",888422400,null),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"private","private",-558947994),new cljs.core.Keyword(null,"ns","ns",441598760),new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"file","file",-1269645878),new cljs.core.Keyword(null,"end-column","end-column",1425389514),new cljs.core.Keyword(null,"column","column",2078222095),new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"end-line","end-line",1837326455),new cljs.core.Keyword(null,"arglists","arglists",1661989754),new cljs.core.Keyword(null,"doc","doc",1913296891),new cljs.core.Keyword(null,"test","test",577538877)],[true,new cljs.core.Symbol(null,"cljs.spec.alpha","cljs.spec.alpha",505122844,null),new cljs.core.Symbol(null,"spec-name","spec-name",-1420007703,null),"cljs/spec/alpha.cljs",17,1,93,93,cljs.core.list(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"spec","spec",1988051928,null)], null)),null,(cljs.core.truth_(cljs.spec.alpha.spec_name)?cljs.spec.alpha.spec_name.cljs$lang$test:null)]));
return (fexpr__57033.cljs$core$IFn$_invoke$arity$1 ? fexpr__57033.cljs$core$IFn$_invoke$arity$1(spec) : fexpr__57033.call(null,spec));
})();
...
throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Call to ",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var fexpr__57040 = new cljs.core.Var(function(){return cljs.spec.alpha.__GT_sym;},new cljs.core.Symbol("cljs.spec.alpha","->sym","cljs.spec.alpha/->sym",-2031271081,null),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"private","private",-558947994),new cljs.core.Keyword(null,"ns","ns",441598760),new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"file","file",-1269645878),new cljs.core.Keyword(null,"end-column","end-column",1425389514),new cljs.core.Keyword(null,"column","column",2078222095),new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"end-line","end-line",1837326455),new cljs.core.Keyword(null,"arglists","arglists",1661989754),new cljs.core.Keyword(null,"doc","doc",1913296891),new cljs.core.Keyword(null,"test","test",577538877)],[true,new cljs.core.Symbol(null,"cljs.spec.alpha","cljs.spec.alpha",505122844,null),new cljs.core.Symbol(null,"->sym","->sym",696606926,null),"cljs/spec/alpha.cljs",13,1,323,323,cljs.core.list(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"x","x",-555367584,null)], null)),"Returns a symbol from a symbol or var",(cljs.core.truth_(cljs.spec.alpha.__GT_sym)?cljs.spec.alpha.__GT_sym.cljs$lang$test:null)]));
return (fexpr__57040.cljs$core$IFn$_invoke$arity$1 ? fexpr__57040.cljs$core$IFn$_invoke$arity$1(v__$1) : fexpr__57040.call(null,v__$1));
})())," did not conform to spec:\n",(function (){var sb__4661__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__57041_57314 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57042_57315 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57043_57316 = true;
var _STAR_print_fn_STAR__temp_val__57044_57317 = ((function (_STAR_print_newline_STAR__orig_val__57041_57314,_STAR_print_fn_STAR__orig_val__57042_57315,_STAR_print_newline_STAR__temp_val__57043_57316,sb__4661__auto__,caller,via,ed,conformed,fn_spec){
return (function (x__4662__auto__){
return sb__4661__auto__.append(x__4662__auto__);
});})(_STAR_print_newline_STAR__orig_val__57041_57314,_STAR_print_fn_STAR__orig_val__57042_57315,_STAR_print_newline_STAR__temp_val__57043_57316,sb__4661__auto__,caller,via,ed,conformed,fn_spec))
;
cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57043_57316;

cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57044_57317;

try{cljs.spec.alpha.explain_out(ed);
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57042_57315;

cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57041_57314;
}
...
var ret = (function (){var _STAR_instrument_enabled_STAR__orig_val__57058 = orchestra_cljs.spec.test._STAR_instrument_enabled_STAR_;
var _STAR_instrument_enabled_STAR__temp_val__57059 = true;
orchestra_cljs.spec.test._STAR_instrument_enabled_STAR_ = _STAR_instrument_enabled_STAR__temp_val__57059;

try{return apply_SINGLEQUOTE_(f,args);
}finally {orchestra_cljs.spec.test._STAR_instrument_enabled_STAR_ = _STAR_instrument_enabled_STAR__orig_val__57058;
}})();
...
var temp__5804__auto___57330 = new cljs.core.Keyword(null,"fn","fn",-1175266204).cljs$core$IFn$_invoke$arity$1(fn_spec);
if(cljs.core.truth_(temp__5804__auto___57330)){
var spec_57331 = temp__5804__auto___57330;
if((cargs == null)){
throw orchestra_cljs.spec.test.no_args_spec(v,fn_spec);
} else {
conform_BANG_(v,new cljs.core.Keyword(null,"fn","fn",-1175266204),spec_57331,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ret","ret",-468222814),(function (){var or__4131__auto__ = cret;
...
return ret;
}finally {orchestra_cljs.spec.test._STAR_instrument_enabled_STAR_ = orig__56855__auto__;
}} else {
return apply_SINGLEQUOTE_(f,args);
}
};
var G__57321 = function (var_args){
var args = null;
...
while (G__57335__i < G__57335__a.length) {G__57335__a[G__57335__i] = arguments[G__57335__i + 0]; ++G__57335__i;}
  args = new cljs.core.IndexedSeq(G__57335__a,0,null);
} 
return G__57321__delegate.call(this,args);};
G__57321.cljs$lang$maxFixedArity = 0;
G__57321.cljs$lang$applyTo = (function (arglist__57336){
var args = cljs.core.seq(arglist__57336);
return G__57321__delegate(args);
});
G__57321.cljs$core$IFn$_invoke$arity$variadic = G__57321__delegate;
return G__57321;
})()
...
var temp__5808__auto___57375 = f.cljs$core$IFn$_invoke$arity$variadic;
if((temp__5808__auto___57375 == null)){
} else {
var variadic_57376 = temp__5808__auto___57375;
ret.cljs$core$IFn$_invoke$arity$variadic = ((function (variadic_57376,temp__5808__auto___57375,fn_spec,conform_BANG_,pure_variadic_QMARK_,apply_SINGLEQUOTE_,ret){
return (function() { 
var G__57377__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(variadic_57376,args);
};
var G__57377 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
while (G__57380__i < G__57380__a.length) {G__57380__a[G__57380__i] = arguments[G__57380__i + 0]; ++G__57380__i;}
  args = new cljs.core.IndexedSeq(G__57380__a,0,null);
} 
return G__57377__delegate.call(this,args);};
G__57377.cljs$lang$maxFixedArity = 0;
G__57377.cljs$lang$applyTo = (function (arglist__57381){
var args = cljs.core.seq(arglist__57381);
return G__57377__delegate(args);
});
G__57377.cljs$core$IFn$_invoke$arity$variadic = G__57377__delegate;
return G__57377;
})()
;})(variadic_57376,temp__5808__auto___57375,fn_spec,conform_BANG_,pure_variadic_QMARK_,apply_SINGLEQUOTE_,ret))
;
}
}
 ...
 */
orchestra_cljs.spec.test.instrument_choose_fn = (function orchestra_cljs$spec$test$instrument_choose_fn(f,spec,sym,p__57175){
...
var over = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57176__$1,new cljs.core.Keyword(null,"gen","gen",142575302));
var stub = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57176__$1,new cljs.core.Keyword(null,"stub","stub",1339145807));
var replace = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57176__$1,new cljs.core.Keyword(null,"replace","replace",-786587770));
 ...
 * Helper for instrument
 */
orchestra_cljs.spec.test.instrument_choose_spec = (function orchestra_cljs$spec$test$instrument_choose_spec(spec,sym,p__57178){
...
var overrides = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57179__$1,new cljs.core.Keyword(null,"spec","spec",347520401));
...
var map__57186 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(orchestra_cljs.spec.test.instrumented_vars),v);
var map__57186__$1 = (((((!((map__57186 == null))))?(((((map__57186.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__57186.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__57186):map__57186);
var raw = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57186__$1,new cljs.core.Keyword(null,"raw","raw",1604651272));
var wrapped = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57186__$1,new cljs.core.Keyword(null,"wrapped","wrapped",1775172701));
...
var map__57216 = temp__5804__auto__;
...
var raw = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57216__$1,new cljs.core.Keyword(null,"raw","raw",1604651272));
var wrapped = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57216__$1,new cljs.core.Keyword(null,"wrapped","wrapped",1775172701));
