...
var G__42140 = cljs.core.PersistentArrayMap.EMPTY;
var G__42141 = native_stack_trace;
var G__42142 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__42143 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__42140,G__42141,G__42142,G__42143) : cljs.stacktrace.parse_stacktrace.call(null,G__42140,G__42141,G__42142,G__42143));
});
...
}catch (e42146){var _e = e42146;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___42214 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5802__auto___42214)){
var seen_errors_42215 = temp__5802__auto___42214;
if(cljs.core.truth_(seen_errors_42215.has(self))){
} else {
seen_errors_42215.add(self);

var temp__5804__auto___42216 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5804__auto___42216)){
var sense_42217 = temp__5804__auto___42216;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_42217)].join('');
} else {
}
}
} else {
