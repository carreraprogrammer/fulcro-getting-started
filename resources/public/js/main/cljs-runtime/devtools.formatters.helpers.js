...
var G__42553 = devtools.prefs.pref(v);
v = G__42553;
continue;
} else {
return v;
...
}catch (e42500){var _e__40810__auto__ = e42500;
return false;
}})();
...
}catch (e42509){var _e__40810__auto__ = e42509;
return false;
}})();
...
}catch (e42511){var _e__40810__auto__ = e42511;
return false;
}}
}
});
...
var vec__42526 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42526,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42526,(1),null);
...
return cljs.core.some((function (p1__42529_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__42529_SHARP_);
}),template);
});
