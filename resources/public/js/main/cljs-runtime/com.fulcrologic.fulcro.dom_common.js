...
return (function (p1__62773_SHARP_){
return cljs.core.re_matches(/^#.*/,p1__62773_SHARP_);
});})(tokens))
,tokens));
var classes = cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (tokens,id){
return (function (p1__62774_SHARP_){
return cljs.core.re_matches(/^\..*/,p1__62774_SHARP_);
});})(tokens,id))
,tokens);
...
var G__62775 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"classes","classes",2037804510),cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(com.fulcrologic.fulcro.dom_common.remove_separators,classes))], null);
if(cljs.core.truth_(sanitized_id)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__62775,new cljs.core.Keyword(null,"id","id",-1388402092),sanitized_id);
} else {
return G__62775;
}
} else {
...
var map__62776 = com.fulcrologic.fulcro.dom_common.parse(kw);
...
var classes = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__62776__$1,new cljs.core.Keyword(null,"classes","classes",2037804510),cljs.core.PersistentVector.EMPTY);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62776__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
...
var G__62780_62796 = props__$1;
var G__62781_62797 = "className";
var G__62782_62798 = com.fulcrologic.fulcro.dom_common.combined_classes(classes,existing_classes);
goog.object.set(G__62780_62796,G__62781_62797,G__62782_62798);
} else {
}
...
var G__62783 = (function (){var or__4131__auto__ = props;
...
var G__62783__$1 = ((cljs.core.seq(classes))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__62783,new cljs.core.Keyword(null,"className","className",-1983287057),com.fulcrologic.fulcro.dom_common.combined_classes(classes,existing_classes)):G__62783);
if(cljs.core.truth_(id)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__62783__$1,new cljs.core.Keyword(null,"id","id",-1388402092),id);
} else {
return G__62783__$1;
}
}
