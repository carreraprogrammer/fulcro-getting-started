...
var G__44384 = z;
if(((24) > (function (){var G__44385 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__44385) : clojure.test.check.random.longs.bit_count.call(null,G__44385));
})())){
return clojure.test.check.random.longs.bit_xor(G__44384,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__44384;
}
});
...
var G__44412 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__44413 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__44412;
ret = G__44413;
continue;
}
...
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44393__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__44395 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44395,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44395,(1),null);
